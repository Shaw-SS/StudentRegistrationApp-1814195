...
public class Search extends Activity{
    ...
    String getmobile = mobile.getText().toString();
    	...
    	b.UpdateData( getusername,  getuniname,
				 getstudidnumber,getgender, getdob,
				 getentryyr, getlevel,  getcountry,
				gethaddress, getmobile);
    	...
    	if(items != ""){
            ...
            myButton.setOnClickListener(new OnClickListener(){
            	...
            	//	haddress.setText(item[10], TextView.BufferType.EDITABLE);
            		mobile = (EditText) findViewById(R.id.txtmob);
            		mobile.setText(item[10], TextView.BufferType.EDITABLE);
