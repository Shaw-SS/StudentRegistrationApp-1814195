...
public class SQLiteHandler extends SQLiteOpenHelper {
	 ...
	 public void InsertData(String getusername, String getuniname, String getstudidnumber, String getgender, String getdob, String getentryyr, 
			 String getlevel, String getcountry, String getdegree,  String gethaddress,
			 String getmobile){
		 try{
	 ...
	 public String getData(String id) {
		 ...
		 final Cursor c = db.rawQuery("SELECT UserName, UniName,StudidNumber, Gender, DOB, EntryYr, Level, Country, Degree,  Haddress, Mobile  FROM " +
		 			SAMPLE_TABLE_NAME +
	 ...
	 public String[] getDataB(String id) {
	    ...
	    int mobil = c.getColumnIndex("Mobile");
	     ...
	     for (c.moveToFirst(); !c.isAfterLast(); c.moveToNext()) {
	         ...
	         //result[9] = c.getString(homeadd);
	         result[10] = c.getString(mobil);
	...
	public void UpdateData(String getusername, String getuniname,
	 ...
	 String gethaddress,  String getmobile) {
